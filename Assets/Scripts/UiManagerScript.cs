...
public class UiManagerScript : singleton<UiManagerScript>
{
  ...
  private void FindActiveUI()
  {
    ...
    {
        splashScreen,mainMenu,battleMenu,options,styleMenu,credits,exit,
        duelMatch,deathMatch,teamDeathMatch,battleGround,quickMenu,areYouSureMenu,
        chooseTeamMenu,battleGroundScene,
    }
